...
if ($_SERVER["REQUEST_METHOD"] === "POST")
{
    ...
    $senderRemarks = $requestData['senderRemarks'];;
    ...
    if ($hashedPINEnteredByUser === $walletPINHash) {
        ...
        $response = transferMoneyW2W($walletAddress, $amountToSend, $senderRemarks, $trnxPurpose, $connect_kuberkosh_db, $connect_wallet_transactions_db);
    } else {
