<?php
// Include the Google authentication file
...
<body>
    ...
    <div class="card card1 mx-md-21 auth-form">
        <form class="mx-auto" action="">
            <div class="mx-auto text-center">
                ...
                if (isset($_GET['signup'])) {
                    ...
                    ?>
                    <h4 class=" auth-h1 text-center  mt-6 mb-3">Complete 2FA</h4>
                    <?php
                }
                ?>
        ...
        <div class="mx-auto">
            <div class="mb-1">
                ...
                <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Enter your TOTO here">
            </div>
        </div>
        <?php
                }
    ...
    <div class=" mt-1 mx-auto text-center" action="">
        ...
        if (isset($_GET['signup'])) {
            ...
            <p class="mt-1 auth-p"> Already have an account? <a href="index.php?login" class="auth-p-link">Log
                    In</a></p>
            <?php
        } elseif (isset($_GET['login'])) {
            ?>
            <button type="submit" class="auth-submit-btn bg-gradient">Log In</button>
            <p class="mt-1 auth-p"> Don't have an account? <a href="index.php?signup" class="auth-p-link">Sign
                    Up</a></p>
            <?php
        } elseif (isset($_GET['test'])) {
            ?>
            <button type="submit" class="auth-submit-btn bg-gradient">Log In</button>
            <p class="mt-1 auth-p"> Lost TOTP? <a href="index.php?signup" class="auth-p-link">Contact Support</a></p>
            <?php
        }
        ?>
    </div>
