...
<div id="assumedBody">
  ...
  <form  id="send_money_form_1" action="" class = "card-form align-to-center" style="margin-top: 8px;">

    <!-- Receivers Address -->
    <div class="form-field__control mt-1" id="money_sending_address_div">
        <input id="receiver_address" type="text" class="form-field__input" placeholder="walletaddress@kkosh">
        <label for="receiver_address" class="form-field__label">Receiver's  address (Kuber Kosh Address)</label>
    ...
    <div class="form-field__control" id="money_sending_remarks_div">
        ...
        <label for="money_sending_remarks" class="form-field__label">Remarks</label>
    </div>
...
<div id = "sendVerifyDiv" class="card card1 align-to-center position-absolute" style="margin-left: 30%; margin-top: 7%; display: none;">
  ...
  <div id = "sendConfirmDiv" class="card card1 align-to-center position-absolute" style="margin-left: 30%; margin-top: 7%; display: none;">
  <img id = "receiverProfilePic" src="https://bit.ly/3Us0eCl" class="rounded-circle receiver-profile-pic " alt="receivers profile pic" width = "100px" height="100px">
