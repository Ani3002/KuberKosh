...
<div id="assumedBody">
  <div id="sendDiv" class="card card1 align-to-center position-relative">
    ...
    <form id="send_money_form_1" action="" class="card-form align-to-center" style="margin-top: 8px;">
      ...
      <div id="money_send_btn_div">
        <button href="#" class="btn btn-primary bg-gradient  text-light font-weight-300"
          id="money_send_btn">SEND</button>
      </div>
  ...
  <div id="sendConfirmDiv" class="card card1 align-to-center position-absolute"
    ...
    <h3 id="trnxMessage" style="width: 500px; height: 30px; position: absolute; margin-left: 190px; margin-top: 280px;">
